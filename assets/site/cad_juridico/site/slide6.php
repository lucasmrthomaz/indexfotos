...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE slaid_6 SET img=%s, titulo=%s, linha_1=%s, linha_2=%s, linha_3=%s, linha_4=%s, linha_5=%s, linha_6=%s, linha_7=%s, data_hora=%s WHERE id=%s",
...
mysql_select_db($database_conexao, $conexao);
$query_DetailRS1 = sprintf("SELECT * FROM slaid_6 WHERE id = %s ORDER BY id DESC", GetSQLValueString($colname_DetailRS1, "int"));
...
mysql_select_db($database_conexao, $conexao);
$query_DetailRS2 = sprintf("SELECT * FROM slaid_6 WHERE id = %s ORDER BY id DESC", GetSQLValueString($colname_DetailRS2, "int"));
