...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE slaid_7 SET img=%s, titulo=%s, linha_1=%s, linha_2=%s, linha_3=%s, linha_4=%s, linha_5=%s, linha_6=%s, linha_7=%s, data_hora=%s WHERE id=%s",
...
mysql_select_db($database_conexao, $conexao);
$query_DetailRS1 = sprintf("SELECT * FROM slaid_7 WHERE id = %s ORDER BY id DESC", GetSQLValueString($colname_DetailRS1, "int"));
...
mysql_select_db($database_conexao, $conexao);
$query_DetailRS2 = sprintf("SELECT * FROM slaid_7 WHERE id = %s ORDER BY id DESC", GetSQLValueString($colname_DetailRS2, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" enctype="multipart/form-data">
  <table width="513" align="center">
    ...
    <tr valign="baseline">
      ...
      <td colspan="2" class="td" align="left" valign="middle"><input type="text" class="vasio" name="data_hora" value="<?php echo htmlentities($row_DetailRS1['data_hora'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
