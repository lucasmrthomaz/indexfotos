...
$query_Recordset1 = "SELECT * FROM cad_cliente ORDER BY id ASC";
$Recordset1 = mysql_query($query_Recordset1, $conexao2) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_conexao2, $conexao2);
$query_Recordset2 = "SELECT * FROM cad_cliente ORDER BY id ASC";
...
<p><a href="buscas.php">prucurar evento</a></p>
</body>
</html>
<?php
