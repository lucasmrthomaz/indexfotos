...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO asides (aside_direita, aside_esquerda) VALUES (%s, %s)",
                       GetSQLValueString($_POST['aside_direita'], "text"),
                       GetSQLValueString($_POST['aside_esquerda'], "text"));

  mysql_select_db($database_conexao2, $conexao2);
  $Result1 = mysql_query($insertSQL, $conexao2) or die(mysql_error());

  $insertGoTo = "cad_aside.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" enctype="multipart/form-data">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" class="td2" align="center">Aside direita:</td>
      <td><input type="file" name="aside_direita" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" class="td2" align="center">Aside esquerda:</td>
      <td><input type="file" name="aside_esquerda" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
