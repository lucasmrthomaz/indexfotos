      ...
      <div>
        <div>
          <div class="card-body">
            ...
            <a id="OverviewPage_ToMyData_Link" href="altera_dados_cadastrais.php?recordID=<?php echo $row_Recordset4['id']; ?>">Visualizar/alterar os dados de cadastro</a></div>
          <div></div>
        </div>
      </div>
    </div>
...
<div class="card  col-md-4">
  <div>
    <div>
      <div>
        <div>
          <h3 class="card-header col-md">Historico de compras </h3>
        </div>
      </div>
    </div>
  </div>
  <div>
    <div>
      <div>
        <div>
          <div class="card-body">
            <p>A GOSPEL EVENTOS armazena todas as compras para posteriores verificações</p>
            <a id="OverviewPage_ToChangePassword_Link" href="altera_senha.php?recordID=<?php echo $row_Recordset4['id']; ?>">Visualizar Historico de compras   </a></div>
          <div></div>
        </div>
      </div>
    </div>
