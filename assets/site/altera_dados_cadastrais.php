...
<section>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        <td><input type="text" name="nome"  class="form-control" placeholder="Nome" value="<?php echo htmlentities($row_DetailRS1['nome'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text" name="sobrenome"  class="form-control" placeholder="Sobrenome" value="<?php echo htmlentities($row_DetailRS1['sobrenome'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text"  class="form-control" placeholder="RG" name="rg" value="<?php echo htmlentities($row_DetailRS1['rg'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text"  class="form-control" placeholder="Confima E-mail" name="confirma_email" value="<?php echo htmlentities($row_DetailRS1['confirma_email'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text"  class="form-control" placeholder="CEP" name="cep" value="<?php echo htmlentities($row_DetailRS1['cep'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text"  class="form-control" placeholder="E-mail" name="email" value="<?php echo htmlentities($row_DetailRS1['email'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text"  class="form-control" placeholder="Senha" name="senha" value="<?php echo htmlentities($row_DetailRS1['senha'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="text"  class="form-control" placeholder="CPF" name="cpf" value="<?php echo htmlentities($row_DetailRS1['cpf'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td><input type="submit"  class="form-control"  value="Atualizar registro" /></td>
      </tr>
    </table>
