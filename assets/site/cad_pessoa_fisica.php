...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cad_cliente (nome, sobrenome, rg, confirma_email, cep, email, senha, cpf, fisico) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "cad_pessoa_fisica.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input name="fisico" type="text" value="Pessoa Fisica" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
