...
<section>
  <p align="center" class="carrinho">Ingressos pagos </p>
  <table width="50%" border="0" align="center" cellpadding="5" cellspacing="5" class="table">
    <tr>
      <td width="12%" align="center"   valign="middle" >Total<br /> <?php echo $totalRows_Recordset6 ?></td>
      <td width="12%" align="center"   valign="middle" >Valor<br /><?php 
echo $a3;
echo ',00';
?></td>
      <td width="12%" align="center"   valign="middle" ><a href="buscas.php">Continuar Comprando</a></td>
      <td width="12%" align="center"   valign="middle" ><a href="boleto.php?id=<?php echo $row_Recordset5['id']; ?>">Pagar</a></td>
    </tr>
  </table><table border="0" align="center" cellpadding="5" cellspacing="5" class="table table-striped">
    ...
    <?php do { ?>
      <tr align="center" valign="bottom" >
        ...
        <td><a href="Ingresso.php?recordID=<?php echo $row_Recordset6['id']; ?>">Imprimir Ingresso</a><br /><a href="altera_ingresso.php?recordID=<?php echo $row_Recordset6['id']; ?>">Edita Titularidade</a></td>
      </tr>
